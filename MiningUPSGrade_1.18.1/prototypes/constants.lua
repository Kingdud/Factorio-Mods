...
--Module stats
--//////////////////////////////////
local spd_module_speed_bonus = data.raw.module["speed-module-3"].effect.speed
local spd_module_pwr_penality = data.raw.module["speed-module-3"].effect.consumption
local prod_mod_speed_penalty = data.raw.module["productivity-module-3"].effect.speed
--local prod_mod_prod_bonus
local prod_mod_pwr_penality = data.raw.module["productivity-module-3"].effect.consumption
local prod_mod_pollution_penalty = data.raw.module["productivity-module-3"].effect.pollution
